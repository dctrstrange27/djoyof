...
const Product = ({product,onAddCart, onAddFav, liked, onRemoveFav, clickableAgain }) => {
  ...
  return (
    <>  
      <div className="relative border-[1px flex border-[1px dark:text-[#fff] text-xs justify-center py-7">
        <div className="relative border-[1px border-green-400 w-[200px] translate-x-4 md:translate-x-0">
          <div className="absolute z-20   -left-16 -top-4 -bottom-[13px] bg-product_bg dark:bg-[#191a1e] justify-center flex rounded-full items-center w-[5rem]
                          h-[5rem] w-max-[4rem] border-[.1px] border-[#944603c2] dark:border-[#f97f2ec2]">
            <img src={product.image} className="w-[3rem] h-[3.5rem]"></img>
          </div>

      
          <div className="pl-10 bg-product_lbl_bg dark:bg-five dark:shadow-2xl shadow-lg shadow-Light_shadow dark:shadow-[#424242d0] py-2 after:content-[''] after:absolute after:w-full after:h-[1px] 
