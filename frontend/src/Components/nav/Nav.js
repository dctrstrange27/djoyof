...
function Nav({ toggleAside, setToggleAside, toggleNav, setToggleNav, userData,
                ...
                <div className={`z-50 relative items-center justify-between h-16 hidden md:flex md:justify-between border-[1px border-cyan-500 md:duration-75`}>
                    <nav className='flex justify-evenly gap-4 items-center h-10 border-[1px border-red-500'>
                        <div onClick={(e) => {
                            ...
                            <Link to='/HomeContent' className='flex'>
                                <IoHome className='w-[1rem] translate-y-[2px] h-auto mr-2'></ IoHome>
                                <h1 className=" rounded-lg duration-200 ease-linear">Home</h1>
                            </Link>
                        </div>
                        <div onClick={(e) => {
                            e.preventDefault()
                            ...
                            <Link to="/Content" className=" rounded-lg duration-200 ease-linear">Content</Link>
                        </div>
                        <div onClick={(e) => {
                            e.preventDefault()
                            setCheckNav(2)
                            ...
                            <BsInfoCircle className='w-[1rem] translate-y-[2px] h-auto mr-2'></BsInfoCircle>
                            <Link to="/About" className=" rounded-lg duration-200 ease-linear"> About</Link>
                        </div>
                        <div onClick={(e) => {
                            e.preventDefault()
                            setCheckNav(3)
                            ...
                            <Link to='/Service' className='flex'>
                                ...
                                <h1 className=" rounded-lg duration-200 ease-linear"> Service</h1>
                            </Link>
                        </div>
                        ...
                        }} className={`flex hover:text-[#ec8f42] ${checkNav === 4 ? "text-[#ec8f42]" : "text-[#8b8b8b]"}   `}>
                            <AiTwotonePhone className='w-[1rem] translate-y-[2px] h-auto mr-2'></ AiTwotonePhone>
                            <Link to="/ContactUs" className=" rounded-lg duration-200 ease-linear"> Conctact Us</Link>
                        </div>
                    </nav>
                    <div className='flex border-[1px justify-evenly  py-2 items-center'>
                        <div className='flex w-[80px] justify-between border-1px]'>
                            <Link to="/Signup" className="flex justify-center items-center font-normal text-gray-900 rounded-lg p-1 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <VscSignIn className="w-5 h-5 text-[#ff3c3c]" />
                            </Link>
                            <Link to="/Signup" className="  text-white rounded-lg ">{userData.customer_name}</Link>
                        </div>
                        <img src={require("../../img/small_logo.png")} className={`bg-green-40  px-10 ${toggleNav && 'hidden'} `}></img>
                    </div>
                </div>
            </div>
            <Outlet />
