        ...
        <div className="bg-[#191616b7] rounded-lg w-96 h-60 flex justify-center">
          <div className="bg-[#fff/20 flex flex-col justify-center items-center gap-5 w-[80%]">
            ...
            <div className="flex gap-16">
              <Link to='/main' className='text-white bg-[#ff7900] text-[#fff] font-bold duration-300 hover:scale-105 border-[1px min-w-20 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-blue-300
