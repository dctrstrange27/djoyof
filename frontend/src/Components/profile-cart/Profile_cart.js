            ...
            <div className='w-[70rem] dark:text-[#fff] flex flex-col  h-screen border-[1px  border-[#Fff]'>
                <div className='flex flex-row h-[17rem] gap-10 border-[1px justify-center    border-[#Fff] '>
                    ...
                    <div className='w-50 border-[1px
                        ...
                        <Link to='Profile' className=' bg-Ofour max-w-[120px] text-[#fff] hover:scale-105 duration-300 text-sm py-1 items-center flex justify-center gap-2 rounded-md'>
                    ...
                    <div className='h-full py-2 border-b-1  border-[#fff] bg-[#5ee7c5da'>
                        <div className={`${currentTab === 0 ? "visible" : "hidden"}  `}>
                                <React.Suspense fallback={ <div className={`w-[70rem] h-screen dark:bg-four border-[1px flex justify-center items-center`}>
                                    <AiOutlineLoading className="text-Ofive w-8 h-auto animate-spin " ></AiOutlineLoading>
                                </div>}>
