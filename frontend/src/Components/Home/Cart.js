...
export const Cart = ({ cartItems, onAdd, onIncrease, onDecrease, onRemove, onRemoveAll }) => {
  ...
  return (
    <>
      <div className="flex flex-wrap py-4 px-32 border-[1px] md:overflow-y-hidden w-screen ">
        <div className="w-full ">
          ...
          <div className="font-pop flex rounded-md text-white overflow-hidden bg-[#141714] h-auto min-h-[70vh]">
            <div
              className="px-12 py-5 pb-[1vh] border-[1px] flex-auto scrollbar-thin scrollbar scrollbar scrollbar-thumb-zinc-600 scrollbar-track-black
