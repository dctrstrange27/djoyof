...
const Home = ({ setLoading,togs,showNotif,setTogs,cartItems, setUseGoogle, setUseLocal, signout, setSignout, currentTab, setCurrentTab }) => {
  ...
  return (
    <div className="relative flex flex-col">
      ...
      <div className="border-b-[1px fixed border-[#7a7a7a75] bg-[#ffffffd4] dark:shadow-xl shadow-lg shadow-Light_shadow dark:shadow-[#00000054] dark:bg-two  w-full z-30">
        <MainNav  showNotif={showNotif}   cartItems={cartItems} currentTab={currentTab} setCurrentTab={setCurrentTab} setUseGoogle={setUseGoogle} signout={signout} setSignout={setSignout} setUseLocal={setUseLocal} hide={hide} setHide={setHide} togs={togs} setTogs={setTogs} />
      </div>
