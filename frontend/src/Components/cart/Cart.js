    ...
    <>
      ...
      <div className="flex w-full border-[1px pb-20 flex-wrap justify-center 
          ...
          <div className="flex flex-col border-[1px border-red-500 px-2
            ...
            <div className="bg-[#141517] shadow-lg shadow-[#00000069] rounded-2xl md:rounded-2xl md:px-5 font-pop flex justify-center items-center text-white">
              <div className="rounded-md px-5 max-h-[100vh] flex-auto ">
