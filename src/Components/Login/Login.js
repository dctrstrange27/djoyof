...
export const Login = () => {
  return (
    <>
      <div class="flex bg-[#24262B] h-screen justify-center md:h-screen lg:h-screen xl:h-screen items-center">
            ...
            <div class="flex flex-col w-full h-auto px-12 bg-[#0f0f11] bg-opacity-[80%] border-white border-y-[1px] md:max-w-[80%] md:translate-x-[4.5rem] border-opacity-25 justify-center z-10 md:w-full md:h-auto md:rounded-[47px] md:py-0 md:px-7 xl:max-w-[65%] xl:translate-x-[25%] 2xl:max-w-[50%] 2xl:translate-x-[50%] 2xl:border-[#F29A4B] 2xl:px-9">
              ...
              <form class='flex flex-col'>
                <div class="mb-4 py-2 z-10">
                  <label class="block mb-1 text-[#CBCBCB] font-['Nunito Sans'] tracking-[0.1rem] z-10" for="email">username</label>
                ...
                <div class="mb-4 z-10">
                  <label class="block mb-1 text-[#CBCBCB] tracking-[0.1rem]" for="password">Password</label>
                ...
                <div class="py-[45px] lg:py-[20px] flex items-center justify-center z-10">
                  <button class="font-['Nunito Sans'] tracking-[0.1rem] w-40 px-4 py-1  bg-[#b18055] self-center border border-transparent rounded-md font-semibold capitalize text-white hover:bg-[#F29A4B] focus:outline-none disabled:opacity-25 transition">Sign In</button>
                </div>
